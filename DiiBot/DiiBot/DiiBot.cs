...
namespace DiiBot
{
    ...
    public class DiiBot : ActivityHandler
    {
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            TeamsMessage input = new TeamsMessage() { Message = messageText,  Tags = tags, ChannelId = turnContext.Activity.TeamsGetChannelId(), UserId = turnContext.Activity.From.AadObjectId, MessageId = turnContext.Activity.ReplyToId, TeamId = TeamsInfo.GetTeamDetailsAsync(turnContext, turnContext.Activity.TeamsGetTeamInfo().Id, cancellationToken).Result.AadGroupId };
